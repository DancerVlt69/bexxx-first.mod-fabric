package net.bexxx.tutorialmod.block.entity;
...
import net.bexxx.tutorialmod.recipe.GemInfusingRecipe;
import net.bexxx.tutorialmod.screen.GemInfusingScreenHandler;
