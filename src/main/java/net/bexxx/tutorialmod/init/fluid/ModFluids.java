...
public class ModFluids {
    ...
    public static void register() {
        STILL_SOAP_WATER = Registry.register(Registry.FLUID,
                new Identifier(MODID, "soap_water"), new SoapWaterFluid.Still());
        FLOWING_SOAP_WATER = Registry.register(Registry.FLUID,
                new Identifier(MODID, "flowing_soap_water"), new SoapWaterFluid.Flowing());
        ...
        SOAP_WATER_BUCKET = Registry.register(Registry.ITEM, new Identifier(MODID, "soap_water_bucket"),
                new BucketItem(ModFluids.STILL_SOAP_WATER, new FabricItemSettings().recipeRemainder(Items.BUCKET)
                                .maxCount(1).group(ModItemGroup.PLANTS)));
