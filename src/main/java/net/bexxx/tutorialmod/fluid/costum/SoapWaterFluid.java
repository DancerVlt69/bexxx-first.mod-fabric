...
public abstract class SoapWaterFluid extends FlowableFluid{
    ...
    public Fluid getStill() {
        return net.bexxx.tutorialmod.fluid.ModFluids.STILL_SOAP_WATER;
    }

    @Override
    public Fluid getFlowing() {
        return net.bexxx.tutorialmod.fluid.ModFluids.FLOWING_SOAP_WATER;
    }

    @Override
    public Item getBucketItem() {
        return net.bexxx.tutorialmod.fluid.ModFluids.SOAP_WATER_BUCKET;
    }
